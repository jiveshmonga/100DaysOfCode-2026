def sort_crates(weights):
    #1: Sort from lightest to heaviest
...
def load_rebel_cargo(weights, limit):
    ...
    for crate_weight in sorted_weights:
        ...
        if can_add:
            #3: Add the crate weight to the total
            ...
            #4: Increase count after selecting a crate
            crate_count += 1
...
#5: Limit must be an integer, not a string
cargo_limit = 10
